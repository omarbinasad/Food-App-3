...
const FeedBack4 = () => {
  ...
  return (
    <div className="FeedBack4-main-wraper">
      <div className="FeedBack4-banner"></div>
      <div className="FeedBack4-half-div-wraper">
        <div className="FeedBack4-rating-div">
          <div className="FeedBack4-imoji-div">
            <Box sx={{ width: "100%" }}>
              ...
              <TabPanel value={value} index={0}>
                <div className="FeedBack4-tab-items">
                  <div className="fb4-tab-btns-wraper">
                  ...
                  <div className="fb4-avrgtaste-btn-div">
                    <button className="fb4-avrgtaste-btn">
                      Taste is average
                    </button>
                  </div>
                  <div className="FeedBack4-sugestion-txt-div">
        ...
        <button className="FeedBack4-send-btn">
